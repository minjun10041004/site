(() => {
  ...
  const SWORDS = [
    /* ---- 범품(凡品) — 2자 ---- */
    { name: '목검', hanja: '木劍', rarity: 0, studyBonus: 600,
    ...
    { name: '단도', hanja: '短刀', rarity: 0, studyBonus: 630,
    ...
    { name: '환도', hanja: '環刀', rarity: 0, studyBonus: 690,
    ...
    { name: '철검', hanja: '鐵劍', rarity: 0, studyBonus: 720,
    ...
    { name: '매화검', hanja: '梅花劍', rarity: 2, studyBonus: 3500, epithet: '매화검존의 후예',
    ...
    { name: '빙혼검', hanja: '氷魂劍', rarity: 2, studyBonus: 3700, epithet: '빙혼선자의 재림',
    ...
    { name: '복마검', hanja: '伏魔劍', rarity: 2, studyBonus: 4000, epithet: '복마검존의 금인',
    ...
    { name: '뇌정검', hanja: '雷霆劍', rarity: 2, studyBonus: 4200, epithet: '벽력검신',

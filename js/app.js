(() => {
  ...
  const NEBELAC_SWORDS = [
    ...
    { id: 'executioners-axe-blade', name: '형인부월검 카에린', title: '심판은 이미 끝났다',
      grade: 'yongmaek', image: 'img/executioners-axe-blade.png', imageAlt: '', baseIncome: 2150,
    ...
    { id: 'plague-abyss-blade', name: '역병나락검 자하른', title: '닿은 것은 천천히 시든다',
      grade: 'geumseo', image: 'img/plague-abyss-blade.png', imageAlt: '', baseIncome: 3600,
    ...
    { id: 'wailing-spirit-cry', name: '망령곡성검 세르힐', title: '들은 자는 반드시 돌아본다',
      grade: 'geumseo', image: 'img/wailing-spirit-cry.png', imageAlt: '', baseIncome: 3800,
    ...
    { id: 'black-flame-devourer', name: '흑염탄식검 자카론', title: '삼킨 것은 재도 남지 않는다',
      grade: 'geumseo', image: 'img/black-flame-devourer.png', imageAlt: '', baseIncome: 4000,
    ...
    { id: 'judgment-scale-blade', name: '심판권형검 아그라스', title: '죄의 무게만큼 날카로워진다',
      grade: 'wangwan', image: 'img/judgment-scale-blade.png', imageAlt: '', baseIncome: 6800,
    ...
    { id: 'nightmare-overlord-throne', name: '악몽패왕검 로엔가', title: '모든 악몽의 근원이자 왕',
      grade: 'wangwan', image: 'img/nightmare-overlord-throne.png', imageAlt: '', baseIncome: 7600,
    ...
    { id: 'ashen-oath-ember', name: '잿불서약검 세이가르', title: '재가 되어도 다시 선다',
      grade: 'cheonseong', image: 'img/ashen-oath-ember.png', imageAlt: '', baseIncome: 15000,
    ...
    { id: 'collapsed-star-void', name: '붕괴항성검 아베론', title: '빛조차 도망치지 못한 별의 최후',
      grade: 'cheonseong', image: 'img/collapsed-star-void.png', imageAlt: '', baseIncome: 16500,
    ...
    { id: 'genesis-gate-warden', name: '개벽문직검 크나스', title: '문 너머를 지키는 마지막 눈',
      grade: 'woncho', image: 'img/genesis-gate-warden.png', imageAlt: '', baseIncome: 78000,
    ...
    { id: 'primordial-silence-blade', name: '태초적막검 카에스타', title: '세계가 시작되기 전, 이미 여기 있었다',
      grade: 'woncho', image: 'img/primordial-silence-blade.png', imageAlt: '', baseIncome: 92000,

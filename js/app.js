(() => {
  ...
  const SWORDS = [
    ...
    /* ---- 설화검(說話劍) — 게임의 최종 등급. 강호에 전해지는 각종 웹소설
       ...
       전설임을 새긴 무늬다. ---- */
    { name: '파천검', hanja: '破天劍', rarity: 6, studyBonus: 3000000, epithet: '천 번의 결말',
    ...
    { name: '진천패도', hanja: '震天覇刀', rarity: 6, studyBonus: 3700000, epithet: '패왕의 진노',
    ...
    { name: '송문고검', hanja: '松紋古劍', rarity: 6, studyBonus: 4300000, epithet: '태극의 근본',
    ...
    { name: '암향매화검', hanja: '暗香梅花劍', rarity: 6, studyBonus: 5000000, epithet: '그윽한 향, 소리없는 참격',
    ...
    { name: '창천검', hanja: '蒼天劍', rarity: 6, studyBonus: 6000000, epithet: '푸른 하늘의 검',
    ...
    { name: '사일검', hanja: '射日劍', rarity: 6, studyBonus: 7300000, epithet: '태양을 쏘아 떨어뜨리다',
    ...
    { name: '반야멸마검', hanja: '般若滅魔劍', rarity: 6, studyBonus: 8700000, epithet: '지혜로 마를 베다',
    ...
    { name: '패왕단혼검', hanja: '霸王斷魂劍', rarity: 6, studyBonus: 10000000, epithet: '혼을 끊는 패왕의 검',

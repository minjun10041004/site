(() => {
  ...
  const SWORDS = [
    /* ---- 범품(凡品) — 2자 ---- */
    { name: '목검', hanja: '木劍', rarity: 0, studyBonus: 380,
    ...
    { name: '단도', hanja: '短刀', rarity: 0, studyBonus: 390,
    ...
    { name: '환도', hanja: '環刀', rarity: 0, studyBonus: 410,
    ...
    { name: '철검', hanja: '鐵劍', rarity: 0, studyBonus: 420,
    ...
    /* ---- 정품(精品) — 3자 ---- */
    { name: '유엽검', hanja: '柳葉劍', rarity: 1, studyBonus: 940,
    ...
    { name: '청류검', hanja: '靑流劍', rarity: 1, studyBonus: 980,
    ...
    { name: '한상검', hanja: '寒霜劍', rarity: 1, studyBonus: 1020,
    ...
    { name: '부월검', hanja: '斧鉞劍', rarity: 1, studyBonus: 1060,
    ...
    { name: '매화검', hanja: '梅花劍', rarity: 2, studyBonus: 1880, epithet: '매화검존의 후예',
    ...
    { name: '빙혼검', hanja: '氷魂劍', rarity: 2, studyBonus: 1960, epithet: '빙혼선자의 재림',
    ...
    { name: '복마검', hanja: '伏魔劍', rarity: 2, studyBonus: 2040, epithet: '복마검존의 금인',
    ...
    { name: '뇌정검', hanja: '雷霆劍', rarity: 2, studyBonus: 2120, epithet: '벽력검신',

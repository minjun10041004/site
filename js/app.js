(() => {
  ...
  const REALMS = [
    ...
    { name: '일류무사', hanja: '一流武士', price: 130000, studyBonus: 100,
      desc: '정파 명문 문파의 후기지수들과 어깨를 견줄 만한 실력을 갖췄다.' },
    { name: '절정 초입', hanja: '絶頂 初入', price: 170000, studyBonus: 150,
      desc: '내공이 단전에 뿌리내리기 시작하며, 명문 대파의 제자로 인정받기 시작하는 경지.' },
    { name: '절정 완숙', hanja: '絶頂 完熟', price: 220000, studyBonus: 150,
      desc: '다루는 무공이 물 흐르듯 자연스러워지고, 한 지역을 대표하는 강자로 자리잡는다.' },
    { name: '절정 극', hanja: '絶頂 極', price: 290000, studyBonus: 150,
      desc: '절정의 끝자락. 이때부터는 어엿한 「고수」로 불리며, 문파나 가문의 수장을 넘보게 된다.' },
    { name: '초절정 초입', hanja: '超絶頂 初入', price: 390000, studyBonus: 200,
      desc: '구파일방과 천마신교의 장로 바로 아래 서열. 중원 전역에 이름이 알려지기 시작한다.' },
    { name: '초절정 완숙', hanja: '超絶頂 完熟', price: 530000, studyBonus: 250,
      desc: '문주, 가주, 방주, 채주급의 실력. 단신으로 수십의 일류 고수를 상대할 수 있다.' },
    { name: '초절정 극', hanja: '超絶頂 極', price: 720000, studyBonus: 250,
      desc: '초절정의 정점. 「초고수」라 불리며, 대문파의 장로 자리를 넘보는 실력자.' },
    { name: '화경 초입', hanja: '化境 初入', price: 990000, studyBonus: 300,
      desc: '몸과 진기가 하나로 화(化)하기 시작하며, 어검(馭劍)의 실마리를 잡는 경지.' },
    { name: '화경 완숙', hanja: '化境 完熟', price: 1400000, studyBonus: 350,
      desc: '천마신교 좌우 호법, 구파일방 장문인급. 진기만으로 병기를 부린다.' },
    { name: '화경 극', hanja: '化境 極', price: 2000000, studyBonus: 450,
      desc: '화경의 정점. 삼대 세력 수뇌부와 어깨를 나란히 하는, 사실상 무림 최정상.' },
    { name: '현경 초입', hanja: '炫境 初入', price: 2800000, studyBonus: 550,
      desc: '생각이 곧 진기가 되어 눈부시게(炫) 빛나는 경지. 살아서는 닿기 힘들다는 벽 너머.' },
    { name: '현경 완숙', hanja: '炫境 完熟', price: 4000000, studyBonus: 650,
      desc: '이기어검을 자유자재로 다루며, 존재 자체가 눈부신 빛으로 화한다.' },
    { name: '현경 극', hanja: '炫境 極', price: 5800000, studyBonus: 750,
      desc: '현경의 끝. 전설로만 회자되던 경지에 실제로 도달한 극소수의 존재.' },
    { name: '생사경 초입', hanja: '生死境 初入', price: 8500000, studyBonus: 900,
      desc: '삶과 죽음의 경계를 손끝으로 다루기 시작하는, 죽어야만 넘볼 수 있다던 금단의 영역.' },
    { name: '생사경 완숙', hanja: '生死境 完熟', price: 13000000, studyBonus: 1100,
      desc: '생과 사가 손안에서 하나가 된다. 존재만으로도 강호에 죽음의 그림자를 드리운다.' },
    { name: '생사경 극', hanja: '生死境 極', price: 19000000, studyBonus: 1400,
      desc: '생사경의 정점. 산 자의 몸으로 죽음 너머를 완전히 지배하는, 전설 속 인물의 경지.' },
    { name: '자연경 초입', hanja: '自然境 初入', price: 29000000, studyBonus: 1700,
      desc: '불로불사에 이르러 자연과 동화되기 시작하는, 인간의 굴레를 벗어난 신비의 경지.' },
    { name: '자연경 완숙', hanja: '自然境 完熟', price: 44000000, studyBonus: 2100,
      desc: '천지의 기운과 완전히 하나가 되어, 늙지도 죽지도 않는 존재로 거듭난다.' },
    { name: '자연경 극', hanja: '自然境 極', price: 68000000, studyBonus: 2600,
      desc: '자연경의 정점. 스스로가 곧 자연의 일부가 되어, 더는 「인간」이라 부를 수 없는 존재.' },
    { name: '공허경 초입', hanja: '空虛境 初入', price: 110000000, studyBonus: 3300,
      desc: '우주의 이치를 어렴풋이 깨닫기 시작하는, 공(空)과 허(虛)의 경계에 선 경지.' },
    { name: '공허경 완숙', hanja: '空虛境 完熟', price: 170000000, studyBonus: 4100,
      desc: '우주의 지혜가 온전히 몸에 스며들어, 만물의 근원을 손바닥 위에 놓고 본다.' },
    { name: '공허경 극', hanja: '空虛境 極', price: 270000000, studyBonus: 5200,
      desc: '공허경의 정점. 텅 빈 듯하나 만물을 품은, 언어로는 형용할 수 없는 미지의 영역.' },
    { name: '여의경 초입', hanja: '如意境 初入', price: 430000000, studyBonus: 6600,
      desc: '뜻하는 대로 만물이 응하기 시작하는, 그 누구도 이르지 못했던 미지의 첫걸음.' },
    { name: '여의경 완숙', hanja: '如意境 完熟', price: 690000000, studyBonus: 8300,
      desc: '무한한 의지(意志) 그 자체가 되어, 이치와 조화를 자유로이 넘나든다.' },
    { name: '여의경 극', hanja: '如意境 極', price: 1120000000, studyBonus: 10500,
